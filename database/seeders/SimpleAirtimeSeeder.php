...
class SimpleAirtimeSeeder extends Seeder
{
    public function run(): void
    {
        $this->command->info('🚀 Creating Simple Airtime USSD Service...');
        ...
        $business = Business::firstOrCreate(
            ...
            [
                ...
                'business_email' => 'admin@quickairtime.com',
                'phone' => '+2348012345678',
                'state' => 'Lagos',
                'city' => 'Lagos',
        ...
        // Create USSD flows
        $this->createFlows($ussd);

        $this->command->info('✅ Simple Airtime USSD Service created successfully!');
        $this->command->info('');
    ...
    private function createFlows($ussd)
    {
        ...
        // Create MTN Flow with External API Call
        $this->createMTNFlow($ussd);
        
        // Create Airtel Flow with External API Call
    ...
    private function createMTNFlow($ussd)
    {
        ...
        // Confirm option with External API Call
        USSDFlowOption::create([
