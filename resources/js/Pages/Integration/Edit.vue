    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link
                    :href="route('integration.show', apiConfig.id)"
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Update your custom API integration</p>
                    </div>
                    ...
                    <form @submit.prevent="submitForm" class="p-6 space-y-8">
                        ...
                        <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            >
                                ...
                                {{ form.processing ? 'Updating...' : 'Update API' }}
                            </button>
                        </div>
                    </form>
                </div>
...
// Initialize form with existing API config data
const form = useForm({
    name: props.apiConfig.name || '',
    description: props.apiConfig.description || '',
    endpoint_url: props.apiConfig.endpoint_url || props.apiConfig.api_url || '',
    method: props.apiConfig.method || '',
    timeout: props.apiConfig.timeout || 30,
    retry_attempts: props.apiConfig.retry_attempts || props.apiConfig.retry_count || 3,
    auth_type: props.apiConfig.auth_type || '',
...
const submitForm = () => {
    ...
    form.put(route('integration.update', props.apiConfig.id), {
        preserveScroll: true,
        preserveState: false,
        onError: (errors) => {
            console.error('Error updating API:', errors);
